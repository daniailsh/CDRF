...
Tree Preprocess(Fp, Lp)
{//random Selection of Item
	//Description *tmp_Item;
	ItemNo Group();
	Tree FormTree();
	int i = 0;
	int nTemp =0;
	...
	//		malloc((numofdata)*sizeof(Description)); //100 number of tmpItem

	//int nCntNum[100] = {0,};
	Boolean bCheckExistOfNum[600] = {false, };
